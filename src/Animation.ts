...
export class Animation {
  ...
  private noise;
  private static readonly NUM_VERTICES: number = 2500;
  ...
  public setStartPosition() {
    ...
    const d = 1021.0;
    const maxTheta = tau * (d / this.gcd(n, d));
    const stepSize = maxTheta / Animation.NUM_VERTICES;
  ...
  public static getNumVertices(): number {
    return Animation.NUM_VERTICES;
  }
